...
for i1 = 1:zt 
  ...
  % image A
  Z1 = conv2(ut_es(M1, fh, 1), g1, 'valid');
  A1 = conv2(ut_es(Z1, fh, 2), g1','valid');
  A2 = conv2(ut_es(Z1, fh, 2), h1','valid');
  Z1 = conv2(ut_es(M1, fh, 1), h1, 'valid');
  A3 = conv2(ut_es(Z1, fh, 2), g1','valid');
  A4 = conv2(ut_es(Z1, fh, 2), h1','valid');
  % image B
  Z1 = conv2(ut_es(M2, fh, 1), g1, 'valid');
  B1 = conv2(ut_es(Z1, fh, 2), g1','valid');
  B2 = conv2(ut_es(Z1, fh, 2), h1','valid');
  Z1 = conv2(ut_es(M2, fh, 1), h1, 'valid');
  B3 = conv2(ut_es(Z1, fh, 2), g1','valid');
  B4 = conv2(ut_es(Z1, fh, 2), h1','valid');
...
for i1 = zt:-1:1
  ...
  % filter (rows)
  A4 = conv2(ut_es(A4, fh, 2), h2', 'valid');   
  A3 = conv2(ut_es(E{3,i1}, fh, 2), g2', 'valid'); 
  A2 = conv2(ut_es(E{2,i1}, fh, 2), h2', 'valid'); 
  A1 = conv2(ut_es(E{1,i1}, fh, 2), g2', 'valid'); 

  % filter (columns)  
  A4 = conv2(ut_es(A4+A3, fh, 1), h2, 'valid');  
  A2 = conv2(ut_es(A2+A1, fh, 1), g2, 'valid');  
