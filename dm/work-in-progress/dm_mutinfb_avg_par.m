function [b_map, d_map]=dm_mutinfb_avg_par(a, b, w)
% A failed attempt to prallelise the localised mutual information metric
...
%
% Someone with experience in matlab parfor may be able to help here.
...
matlabpoo(4);
parfor i=1:step:size(a_sampling_maps, 2)
